                ...
                product && <Fragment>
                    ...
                    <div className='row d-flex justify-content-around'>
                        ...
                        <div className='col-12 col-lg-5 mt-5'>
                            ...
                            <p id="product_id">ID del Producto {product.public_id}</p>
                            <hr />
                            ...
                            <div className="alert alert-danger mt-5" type="alert">Iniciar Sesión para dejar tu review</div>

                            {/*Mensaje emergente para dejar una opinion*/}
                                        ...
                                        <div className="modal-dialog" role="document">
                                            <div className="modal-content">
                                                ...
                                                <div className="modal-body">
                                                    ...
                                                    <button className="btn my-3 float-rigth review-btn px-4 text-white" data-dismiss="modal" aria-label="Close">Enviar</button>                                     
                                                </div>
                                            </div>
                                        </div>
                                    </div>
