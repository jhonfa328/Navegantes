    ...
    return (
        <Fragment>
            {loading ? <i class="fa fa-spinner fa-pulse fa-3x fa-fw"></i> :(
                <Fragment>
                    <MetaData title="La mejor tienda deportiva"></MetaData>
                    <h1 id="encabezados_productos">Nueva Coleccion</h1>

                    <section id="productos" className='container mt-5'>
                        <div className='row'>

                            {productos && productos.map(producto => (
                                <div key={producto._id} className='col-sm-12-md-6 col-lg-3 my-3'>
